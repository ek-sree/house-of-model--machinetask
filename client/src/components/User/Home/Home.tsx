...
const Home = () => {
  ...
  return (
    <div className='bg-gradient-to-b from-black to-slate-900 rounded-lg min-h-[710px]'>
        {isAuthenticated?<div className='text-4xl font-bold bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent pl-8 pt-7'>
